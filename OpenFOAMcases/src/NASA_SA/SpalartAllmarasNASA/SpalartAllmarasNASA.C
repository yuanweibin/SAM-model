...
tmp<volScalarField> SpalartAllmarasNASA<BasicTurbulenceModel>::chi() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SpalartAllmarasNASA<BasicTurbulenceModel>::fv1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> SpalartAllmarasNASA<BasicTurbulenceModel>::fv2
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SpalartAllmarasNASA<BasicTurbulenceModel>::ft2
(
    const volScalarField& chi
) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> SpalartAllmarasNASA<BasicTurbulenceModel>::Stilda()
const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> SpalartAllmarasNASA<BasicTurbulenceModel>::fw
(
...
template<class BasicTurbulenceModel>
void SpalartAllmarasNASA<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
SpalartAllmarasNASA<BasicTurbulenceModel>::SpalartAllmarasNASA
(
...
template<class BasicTurbulenceModel>
bool SpalartAllmarasNASA<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SpalartAllmarasNASA<BasicTurbulenceModel>::DnuTildaEff() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SpalartAllmarasNASA<BasicTurbulenceModel>::k() const
{
    // (B:Eq. 4.50)
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SpalartAllmarasNASA<BasicTurbulenceModel>::epsilon() const
{
    // (B:Eq. 4.50)
    const scalar Cmu = 0.09;
...
template<class BasicTurbulenceModel>
tmp<volScalarField> SpalartAllmarasNASA<BasicTurbulenceModel>::omega() const
{
    // (P:p. 384)
...
template<class BasicTurbulenceModel>
void SpalartAllmarasNASA<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
